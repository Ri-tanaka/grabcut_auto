...
作成したツールを用いることによって、数日単位で作業効率を向上させることに成功しました。
...
## 機能一覧
- grabcut_auto.py - [grabcutのプログラム](https://github.com/opencv/opencv/blob/master/samples/python/grabcut.py)（マウス操作によって前景領域抽出を行うプログラム） をベースに作成したプログラム[grabcut_manual.py](https://github.com/Ri-tanaka/grabcut_manual)に顔認識の機能を追加しました。
